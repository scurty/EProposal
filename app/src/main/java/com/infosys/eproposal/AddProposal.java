...
public class AddProposal extends Activity {
    ...
    private void CarregaPrimeiroProp(String text) {
        ...
        if (propList.size() == 0) {
            ...
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "sumario.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu12));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "conteudo.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu13));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "sumario_executivo.png");
            bd.inserirPropItem(propitem_insrt);
            ...
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "produtos_e_servicos_capa.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu22));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "produtos_e_servicos.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu23));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "presenca_global.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu24));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "perfil_corporativo_global.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu25));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "perfil_corporativo_brasil.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu26));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "clientes.png");
            bd.inserirPropItem(propitem_insrt);
            ...
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "experiencia.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu302));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "alliage.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu303));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "hersheys.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu304));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "infosys.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu305));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "johnson_controls.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu306));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "skf.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu307));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "toyota.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu308));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "zurich.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu309));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "the_linde_group.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu310));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "bg_group.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu311));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "cerradinho.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu312));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "syngenta.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu313));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "globonet.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu314));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "arcelor.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu315));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "nindera.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu316));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "ref_ams_brasil_suporte.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu317));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "ref_ams_brasil_suporte_oracle.png");
            bd.inserirPropItem(propitem_insrt);
            ...
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "alguns_nossos_produtos.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu42));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "infosys_fiscal_ingine.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu43));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "infosys_fiscal_ingine2.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu44));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "information_plataform.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu45));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "panaya.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu46));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "rpa.png");
            bd.inserirPropItem(propitem_insrt);

            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu47));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "skava.png");
            bd.inserirPropItem(propitem_insrt);
            ...
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "agradecimento.png");
            bd.inserirPropItem(propitem_insrt);


            propitem_insrt.setSeq(seq++);
            propitem_insrt.setName(getResources().getString(R.string.menu52));
            propitem_insrt.setPath(Memory.FindDir("/Data/", getApplication()) + "fim.png");
            bd.inserirPropItem(propitem_insrt);
