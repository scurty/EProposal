...
public class BDCore extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase bd) {
        ...
        bd.execSQL("create table prop(_id integer primary key autoincrement, name text not null, type int , description text not null, image blob);");
        bd.execSQL("create table prop_item   (_id integer primary key autoincrement, id_prop integer not null, seq int not null, image blob);");
